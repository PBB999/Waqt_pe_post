...
import { CalendarCheck, CommandIcon, CreditCard } from 'lucide-react-native';
...
const DeliveryDetails = ({ route, navigation }) => {
    ...
    const handleReschedule = () => {
        Alert.alert('Reschedule', 'Are you sure you want to reschedule this delivery?', [
            {
                text: 'Cancel',
                style: 'cancel',
            },
            {
                text: 'Reschedule',
                onPress: () => navigation.navigate('Reschedule', { deliveryId: currentParcel._id })
            },
        ]);
    }

    handleFeedback = () => {
        navigation.navigate('Feedback', { deliveryId: currentParcel._id });
    }
